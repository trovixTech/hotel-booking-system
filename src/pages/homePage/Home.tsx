...
const home = () => {
  return (
    <Box className="w-full h-100 flex items-center justify-center bg-black/90 relative" data-aos="fade-up" >
      <Box
      ...
      <Box className="absolute w-full h-80 flex items-center justify-center flex-col">
        <Typography
          ...
          sx={{
            ...
            fontFamily: 'Story Script, SF Mono, SF Mono-Regular, Consolas, "Liberation Mono", Menlo, Courier, monospace',
          }}
          >
